...
for _, dirs, _ in walklevel(rootDir, 0):
	...
	overallDelays += delays
	print "Average delay: " + str(sum(delays)/len(delays))

overallDelays.sort()
pp.pprint(overallDelays)
print "Overall average delay: " + str(sum(overallDelays)/len(overallDelays))
print "Overall median: " + str(overallDelays[len(overallDelays)/2])
